...
const SliderMenu = ({isOpen, onClose, playSound}) => {
    return (
        ...
        >
            ...
            >
                {[
                    {href: "https://x.com/jinethvip", src: "/twitter.webp"},
                    {href: "https://t.me/jinethvip", src: "/telegram.webp"},
                ].map((icon, index) => (
                    <a
                        key={index}
                        href={icon.href}
                ...
                <div className={"w-[48px] flex items-center justify-center h-[48px] rounded-full bg-white"}>
                    <Image src={"/ic (3).svg"} alt={"dextool"} width={44} height={44}/>
                </div>
                <div className={"w-[48px] flex items-center justify-center h-[48px] rounded-full bg-white"}>
                    <Image src={"/icw (1).svg"} alt={"dextool"} width={42} height={42}/>
                </div>
            </div>
        </div>
    );
